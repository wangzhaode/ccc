...
class ApiClient {
 public:
  ...
  ApiResponse chat(const json& system_prompt, const json& messages, const json& tools,
 ...
 private:
  ...
  ApiResponse chat_anthropic(const json& system_prompt, const json& messages, const json& tools,
                             StreamTextCallback on_text);

  ApiResponse chat_openai(const json& system_prompt, const json& messages, const json& tools,
                          StreamTextCallback on_text);
