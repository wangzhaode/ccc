...
class ContextManager {
 public:
  ...
  bool maybe_compress(json& messages, const json& system_prompt, const json& tools, ApiClient& api);

  // Force compress (for /compact command)
  bool force_compress(json& messages, const json& system_prompt, const json& tools, ApiClient& api);
